...
@interface APPosRollRequestTest : APPosBaseTest
            ...
            switch (state.flow) {
                ...
                case SPIFlowIdle:
                    ...
                    if (!self.didProcessCommandDict[@(APCommandPurchaseInitiate)]) {
                        ...
                        [self.spi initiatePurchaseTx:[SPIRequestIdHelper idForString:@"prchs"] amountCents:10051 completion:^(SPIInitiateTxResult *result) {
