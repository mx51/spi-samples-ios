...
@interface APPosCancelPurchaseTest : APPosBaseTest
            ...
            switch (state.flow) {
                ...
                case SPIFlowTransaction:
                    ...
                    if (!state.txFlowState.isFinished) {
                        ...
                        if (!self.didProcessCommandDict[@(APCommandTxCancel)]) {
                            self.didProcessCommandDict[@(APCommandTxCancel)] = @YES;
            ...
            switch (state.txFlowState.type) {
                ...
                case SPITransactionTypePurchase: {
                    ...
                    if (state.txFlowState.isFinished && state.txFlowState.successState == SPIMessageSuccessStateSuccess) {
                        ...
                        XCTAssertEqualObjects(purchaseResponse.getResponseText, @"TRANS CANCELLED");
